...
//               <span className="font-[family-name:var(--font-space-grotesk)] text-3xl font-bold text-foreground">
//                 ${product.price}
//               </span>
...
//               <Button size="lg" className="flex-1 gap-2 rounded-full text-sm font-semibold">
//                 Add to Cart - ${product.price}
//               </Button>
//               <Button size="lg" variant="outline" className="rounded-full border-border/50 text-sm font-semibold text-foreground hover:bg-secondary">
//                 Buy Now
//               </Button>
//             </div>
